...
<head>
    ...
    <style>
        ...
        .px-4.py-3.border-t {
            background: #071018 !important;
            border-top-color: #0f1720 !important;
        }
        ...
        /* File links / text overrides inside iframe */
        .text-gray-800 {
            color: #e6eef0 !important;
        }
...
<body class="flex flex-col">
    ...
    <div class="flex flex-col h-screen bg-transparent">
        ...
        {{-- Chat Header --}}
        <div
            class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-transparent shrink-0 shadow-sm">
                    ...
                    <div class="flex flex-col {{ $isMine ? 'items-end' : 'items-start' }} max-w-xs lg:max-w-md">
                        @if (!$isMine)
                            <span class="text-xs font-medium text-gray-600 mb-1 ml-1">
                                {{ $user->name }}
                                <span
                                    class="text-gray-400 font-normal ml-1">{{ $msg->created_at->format('h:i A') }}</span>
                            </span>
                        @endif
                        ...
                        @if ($isMine)
                            <span
                                class="text-[10px] text-gray-400 mt-1 mr-1">{{ $msg->created_at->format('h:i A') }}</span>
                        @endif
                    </div>
                </div>
            @endforeach
        ...
        {{-- Input Area --}}
        <div class="px-4 py-3 border-t border-gray-100 bg-transparent shrink-0">
            ...
            <div class="flex items-end gap-2 relative">
                ...
                <input type="file" id="file-input-video" accept="video/*" class="hidden"
                    onchange="handleFileSelect(this)">
                <input type="file" id="file-input-document" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt"
                    class="hidden" onchange="handleFileSelect(this)">
                <input type="file" id="file-input-audio" accept="audio/*" class="hidden"
                    onchange="handleFileSelect(this)">

                {{-- File picker popup --}}
                <div id="file-picker-menu"
                    class="hidden absolute bottom-16 left-4 bg-white rounded-2xl shadow-xl border border-gray-100 p-2 z-50 w-52">
                    ...
                    <button type="button" onclick="triggerFileInput('file-input-image')"
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center group-hover:bg-purple-200 transition shrink-0">
                    ...
                    <button type="button" onclick="triggerFileInput('file-input-video')"
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center group-hover:bg-pink-200 transition shrink-0">
                    ...
                    <button type="button" onclick="triggerFileInput('file-input-document')"
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center group-hover:bg-blue-200 transition shrink-0">
                    ...
                    <button type="button" onclick="triggerFileInput('file-input-audio')"
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center group-hover:bg-green-200 transition shrink-0">
