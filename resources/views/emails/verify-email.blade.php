...
<div class="wrapper">
 ...
 {{-- Header --}}
<div class="header" style="background: linear-gradient(135deg, #0B3D2E 0%, #2D6A4F 100%); border-radius: 16px 16px 0 0; padding: 28px 36px; text-align: center;">
    <span class="logo-box" style="display: inline-block; background: rgba(255,255,255,0.2); border-radius: 10px; width: 38px; height: 38px; line-height: 38px; text-align: center; vertical-align: middle;">
    ...
    <span class="logo-text" style="font-size: 20px; font-weight: 700; color: #ffffff; vertical-align: middle; margin-left: 10px; letter-spacing: -0.3px;">
        Onboardify
    </span>
</div>
        {{-- Body --}}
